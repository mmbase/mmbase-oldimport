...
public class EmailSender {	
    ...
    */
     ...
     *  
     */
    public void sendEmail(String emailFrom, String nameFrom, List<String> toAddresses, String subject, String body, DataSource dataSource) throws UnsupportedEncodingException, MessagingException
    {    	    	
     ...
     *  
     */
    public void sendEmail(String emailFrom, String nameFrom, String emailTo, String subject, String body) throws UnsupportedEncodingException, MessagingException
    {    	
    	if (StringUtil.isEmptyOrWhitespace(emailFrom)) {
    		emailFrom = PropertiesUtil.getProperty("mail.system.email");            
        }     	
