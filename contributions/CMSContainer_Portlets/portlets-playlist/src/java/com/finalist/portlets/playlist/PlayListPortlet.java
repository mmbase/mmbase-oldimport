...
/** Displays a playlist from an XML-file. The location of the XML-file must be defined
 * in the portlet.
 * 
 * @author robm
 * @author Cati Macarov
				...
				try {
		            ...
		            if (file.exists()) {
			            try {
			                ...
			                // if xml file is corrupt jaxb throws NPE instead of JAXBExceptions sometimes
