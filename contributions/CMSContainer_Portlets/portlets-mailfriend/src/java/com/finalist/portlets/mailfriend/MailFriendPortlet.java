...
public class MailFriendPortlet extends ContentPortlet {
    ...
    private boolean sendEmail(Cloud cloud, String toname, String toemail, String fromname, String fromemail, Node mailfriend, ActionRequest request, String articleNumber) {
    	boolean sent = false;
