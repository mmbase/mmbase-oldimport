...
<tr>
   ...
   <td>
      ...
      ${name}
      <input class="checkbox" type="checkbox" value='${tagId}' name="tag-${newsletterId}" style="width: 15px;"
             id="tag-${newsletterId}" onclick="addOrRemoveTag(${newsletterId},${tagId},this,'${contextPath}')"
             selected="${selected}"
   ...
   <td>
      ...
      <input class="checkbox" type="checkbox" value="${newsletterId}" name="subscription-${newsletterId}"
      ...
      <input class="checkbox" type="checkbox" value="${newsletterId}" name="pause-${newsletterId}" style="width: 15px;"
             id="pause-${newsletterId}" onclick="modifyStatus(${newsletterId},'PAUSED',this,'${contextPath}')"
                                        <c:if test="${isPause}">checked</c:if>
                                        <c:if test="${disabledPause}">disabled</c:if>/>
   </td>
   <td>
      <select name="format-${newsletterId}" onchange="modifyFormat(${newsletterId},this.value,'${contextPath}')"
