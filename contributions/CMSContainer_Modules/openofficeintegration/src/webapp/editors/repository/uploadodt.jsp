...
<mm:cloud jspvar="cloud">
    ...
    <div class="editor" style="height:500px">
                    ...
                    <tr>
                        <td><input type="file" name="odtfile"/>
                            <c:if test="${odtDoc == false}">
                                <span style="color:red">The file must be OpenOffice odt type!</span>
                            </c:if></td>
                    </tr>
                    <tr>
                        <td><input type="button" name="uploadButton" onclick="upload();"
                                   value="<fmt:message key="attachments.upload.submit" />"/>
                        </td>
                    </tr>
                </table>
            </form>
        ...
        <div class="ruler_green">
            <div><fmt:message key="odtupload.attachmentlist"/></div>
        </div>
        <div class="body">
            <div id="busy">
            ...
            <c:if test="${not empty binaries}">
                <table width="100%" border="0">
                    <tr>
                        <td></td>
                        <td><fmt:message key="odtupload.file.title"/></td>
                    </tr>
                    <c:forEach var="entity" items="${binaries}" varStatus="status">
                        ...
                        <td><a href="DeleteOdt.do?parent=${parent}&name=${entity.title}"><img
                                src="../gfx/icons/delete.png" width="16" height="16" title="delete"
                                alt="delete"/></a></td>
                ...
                <form action="../upload/OdtStore.do">
                    <input type="submit" value="<fmt:message key="odtupload.file.save"/>"/>
