...
public class RatingUtil {
    ...
    * 
    * @param contentNumber The number (identifier) of the content
    * @return The average rating for this element given by all the users
    *          This object will hold the rating.
    *          And the number of users which rated. Returns 0 for the count
    *          and -1 for the rating when the element has not been rated.
    * @todo implement
    */
   public static Rating getContentRating(int contentNumber) {
      Cloud cloud = CloudProviderFactory.getCloudProvider().getCloud();
      NodeList ratingList = cloud.getList(null, "contentelement,rating", "rating.rating", "contentelement.number = "+contentNumber, null, null, null, false);
      float rating = -1;
      int count = 0;
   ...
   /**
    * Sets the rating of a certain content element for the given user
