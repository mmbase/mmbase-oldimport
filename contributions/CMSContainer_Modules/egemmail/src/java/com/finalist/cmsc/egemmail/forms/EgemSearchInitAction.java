...
public class EgemSearchInitAction extends MMBaseAction {
	...
	protected ActionForward execute(ActionMapping mapping, EgemSearchForm form, HttpServletRequest request, HttpServletResponse response, Cloud cloud) throws Exception {
