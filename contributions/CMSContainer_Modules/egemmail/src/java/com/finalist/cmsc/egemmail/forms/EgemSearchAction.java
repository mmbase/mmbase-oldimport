...
public class EgemSearchAction extends MMBaseAction {
	...
	protected ActionForward doSearch(ActionMapping mapping, EgemSearchForm form,
		...
		int offset = StringUtil.isEmptyOrWhitespace(form.getPage()) ? 0 : Integer.parseInt(form
				.getPage());
	...
	private void removeUnpublished(Cloud cloud, NodeList results) {
		...
		NodeList remoteNodes = cloud.getNodeManager("remotenodes").getList(constraints.toString(),
				null, null);
