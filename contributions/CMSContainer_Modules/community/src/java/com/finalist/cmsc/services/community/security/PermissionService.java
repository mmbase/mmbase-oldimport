...
public interface PermissionService {
   ...
   //
   // void deletePermission(Object resource, String authority, String permission);
   //
   // void clearPermission(Object resource, String authority);
   //
   // void setPermission(Object resource, String authority, String permission, boolean allow);
   //
   // Map<Object, Set<AccessPermission>> getAllSetPermissionsForAuthority(String authority);
