    ...
    private void cleanContentElements(Cloud cloud) {
        ...
        if (!queryNodes.isEmpty()) {
            ...
            while (ni.hasNext()) {
                ...
                log.info("Deleting expired node (" + element.getNodeManager().getName() + "} "
                        + element.getNumber());
                try {
                    ...
                    // for some reason cleaning will fail because of invalid remotesnodes data
                    // just log the stacktrace and don't interrupt cleaning of other contentelements
