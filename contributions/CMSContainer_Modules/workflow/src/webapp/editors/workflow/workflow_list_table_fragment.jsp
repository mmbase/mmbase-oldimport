...
<thead>
   <tr>
      ...
      <th style="width: 68px;"> <a href="#" <%=onClickandStyle(pageContext, "type")%>><fmt:message key="workflow.type"/></a></th>
      <th style="width: 68px;"><a href="#" <%=onClickandStyle(pageContext, "number")%>><fmt:message key="workflow.number"/></a></th>
      <th style="width: 50px;">
