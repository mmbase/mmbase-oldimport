...
public class CompleteWizardAction extends MMBaseAction {
   ...
   private Node createPortlet(Cloud cloud, PageWizardForm wizardForm, Node newPageNode, Node wizardPortletNode) {
      ...
      try {
         ...
         throw new IllegalArgumentException("No view set for portlet "+portletPosition+" in wizard with number: "+wizardForm.getWizard());
      }
      ...
      try {
         ...
         throw new IllegalArgumentException("No portletdefinition set for portlet "+portletPosition+" in wizard with number: "+wizardForm.getWizard());
      }
