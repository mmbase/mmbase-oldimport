                ...
                switch (state) {
                    case  1 :
                        if (("property" == ___local)&&("" == ___uri)) {
                            _getProperty().add(((nl.leocms.connectors.UISconnector.input.customers.model.impl.PropertyImpl) spawnChildFromEnterElement((nl.leocms.connectors.UISconnector.input.customers.model.impl.PropertyImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("property" == ___local)&&("" == ___uri)) {
                    ...
                    case  2 :
                        if (("propertyId" == ___local)&&("" == ___uri)) {
                            _getProperty().add(((nl.leocms.connectors.UISconnector.input.customers.model.impl.PropertyTypeImpl) spawnChildFromEnterElement((nl.leocms.connectors.UISconnector.input.customers.model.impl.PropertyTypeImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
