...
if(thisEvent.getLongValue("einddatum") * 1000 < (new Date()).getTime()) {
   ...
   ticketIcon = "/editors/img/ticket_no.gif";
   ...
   if(Evenement.isGroupExcursion(cloud,parentEvent.getStringValue("number"))
      ...
      ticketIcon = "/editors/img/ticket_waitingforconfirm.gif";
   ...
   ticketIcon = "/editors/img/ticket_open.gif";
   ...
   ticketIcon = "/editors/img/ticket.gif";
