...
<mm:import id="bannerurl">http://demo.mediacompitence.nl</mm:import>

<%-- de tekst van de link zoals deze in de top van alle pagina's verschijnt--%>
<mm:import id="bannerurltext">demo.mediacompitence.nl</mm:import>
...
<mm:import id="gemeentenaam">222</mm:import>
...
<mm:import id="applicationemail">info@uwgemeente.nl</mm:import>
...
<mm:import id="producenturl">http://egemmail.nl/producent/</mm:import>

<%-- de url waarop de applicatie voor de beheerder te bereiken is --%>
<mm:import id="adminurl">http://egemmail.nl/beheerder/</mm:import>
...
<mm:import id="signaturename">EGEM</mm:import>
