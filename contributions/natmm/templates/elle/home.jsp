...
<!-- homepage template -->
 ...
 if (document.images) { 
	...
	nav_search_off.src 			= "/assets/nav/search.gif"; 
	nav_search_on      			= new Image(); 
	nav_search_on.src 			= "/assets/image/2005/0927200518462776.gif"; 
	nav_go_off    				= new Image(); 
	nav_go_off.src 				= "/assets/image/2005/0927200518462375.gif"; 
	nav_go_on      				= new Image(); 
	nav_go_on.src 				= "/assets/image/2005/0927200518472711.gif"; 
	...
	nav_more_off.src 			= "/images/nav/more.jpg"; 
	nav_more_on      			= new Image(); 
	nav_more_on.src 			= "/images/nav/more_on.jpg"; 
	nav_archives_off    		= new Image(); 
	nav_archives_off.src 		= "/images/nav/archives.jpg"; 
	nav_archives_on      		= new Image(); 
	nav_archives_on.src 		= "/images/nav/archives_on.jpg"; 
	...
	nav_bfeatnews_off.src		= "/assets/image/2005/0923200516374907.gif"; 
	nav_bfeatnews_on			= new Image(); 
	nav_bfeatnews_on.src		= "/assets/image/2005/0923200516443466.gif"; 
	...
	nav_books_off.src 			= "/assets/image/2005/0923200516375091.gif"; 
	nav_books_on      			= new Image(); 
	nav_books_on.src 			= "/assets/image/2005/0923200516443608.gif"; 
