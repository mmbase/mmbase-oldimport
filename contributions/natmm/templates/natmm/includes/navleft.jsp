 <%
 if(iRubriekLayout==SUBSITE2_LAYOUT) { %>
   <style>
      span.navbutton {
...
<% if(iRubriekLayout!=DEFAULT_LAYOUT) { 
   %><tr>
	   <td height="1" class="leftnavline" style="<%= 
	         (iRubriekLayout==SUBSITE1_LAYOUT ? "background-color:#050080;" : "background-color:#F06E23;" ) 
   ...
   if(!nextPage.equals("-1")) {
      ...
      <tr>
      	<td style="text-align:right;width:165px;line-height:85%;padding:0px;<%= 
      	      (iRubriekLayout==SUBSITE2_LAYOUT ? "background-color:#10086B;" : "" ) %>"><%
      	   if(navCnt==0) {
      ...
      <tr>
      	<td height="1" class="leftnavline" <% 
      	   if(iRubriekLayout==SUBSITE1_LAYOUT) { 
      	      %>style="background-color:#050080;"<% 
      	   } else if(iRubriekLayout==SUBSITE2_LAYOUT) {
