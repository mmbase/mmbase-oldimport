...
<% String templatesUrl = request.getParameter("tu");
   extendedHref = pageUrl + "&p=bel";
		...
		<table width="180" cellspacing="0" cellpadding="0">
			...
			<td class="titlebar" style="vertical-align:middle;padding-right:2px;" width="100%"><nowrap><a href="<%@include file="../includes/extendedhref.jsp" 
				...
				<% ResourceBundle bd = ResourceBundle.getBundle("ApplicationResources"); 
					String sParagraafOmschrijving = bd.getString("phonelink.paragraaf.omschrijving");%>
	...
	<tr>
		<td class="subtitlebar" width="180" colspan="2"><bean:message bundle="LEOCMS" key="phonelink.paragraaf.titel" /></td>
	</tr>
</table>