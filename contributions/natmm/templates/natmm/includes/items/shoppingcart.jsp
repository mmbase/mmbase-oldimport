   ...
   <% if(!shopitem_type.equals("uitverkocht")&&!shopitem_type.equals("niet_te_koop")) { %>
   	<table width="100%" cellspacing="0" cellpadding="0">
   		<tr>
   			...
   			<td class="maincolor" width="100%" style="font-size:12px;padding-left:1px;"><a href="<mm:url page="<%= extendedHref %>" />" class="white">In winkelwagentje</a></td>
   		...
   		<tr>
   			...
   			<td class="maincolor" width="100%" style="font-size:12px;padding-left:1px;"><a href="<mm:url page="<%= extendedHref %>" />" class="white">Direct bestellen</a></td>
   			<td class="maincolor" width="0%" style="vertical-align:bottom;padding:2px;"><a href="<mm:url page="<%= extendedHref %>" />"><img src="media/shop/pijl_wit_op_oranje.gif" border="0" alt=""></a></td>
   		</tr> --%>
   	</table>
	<% } else { %>
