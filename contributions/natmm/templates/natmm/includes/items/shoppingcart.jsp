   ...
   <% if(!shopitem_type.equals("uitverkocht")&&!shopitem_type.equals("niet_te_koop")) { %>
   	<table width="100%" cellspacing="0" cellpadding="0">
   		<tr>
   			...
   			%><td class="titlebar" style="padding-left:5px;" width="0%"><a href="<mm:url page="<%= extendedHref %>" />"><img src="media/shop/w_wagentje.gif" border="0" alt=""></a></td>
   		...
   		<tr>
   			...
   			%><td class="titlebar" width="0%"><table cellspacing="1" cellpadding="0"><tr><td style="background-color:#FFFFFF;"><a href="<mm:url page="<%= extendedHref %>" />"><img src="media/shop/w_wagentje_op_wit.gif" border="0" alt=""></a></td></tr></table></td>
