<table width="180" cellspacing="0" cellpadding="0" align="right">
	<tr>
		...
		<table width="180" cellspacing="0" cellpadding="0">
			...
			<td class="maincolor" style="vertical-align:middle;background-color:#5D5D5D;"><img src="media/trans.gif" width="1" height="1" border="0" alt=""><input type="text" name="memberid" style="width:88px;height:15px;" value="<%= memberId %>"></td>
			<td class="maincolor" width="100%" style="vertical-align:middle;text-align:center;background-color:#5D5D5D;">
				...
				class="white"><bean:message bundle="LEOCMS" key="shoppingcart.membershipsform.i_am_member" /></a></td>
