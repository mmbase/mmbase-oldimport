         ...
         <mm:relatednodes type="pagina" path="posrel,pagina" orderby="posrel.pos" max="1">
           ...
           <td style="vertical-align:top;width:170px;border-color:#828282;border-width:1px;border-style:solid" 
            ...
            <div style="padding:3px 5px 10px 5px">  
               <a href="<%= ph.createPaginaUrl(pageNumber,request.getContextPath()) %>" class="hover" style="font:bold 115%;color:#<%=color1[iRubriekStyle]%>;"><mm:field name="titel"/></a>
               ...
               <div style="padding-top:3px;">
                  <a href="<%= ph.createPaginaUrl(pageNumber,request.getContextPath()) %>" style="font:90%;color:#<%=color1[iRubriekStyle]%>;" title="<mm:field name="titel"/>"><%= sReadmore %></a> <span style="color:#<%=color1[iRubriekStyle]%>">></span>
               </div>
            </div>
           </td>
           </mm:field>
