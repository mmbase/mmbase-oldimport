...
<table cellspacing="0" cellpadding="0" border="0" valign="top">
   <tr>
      <td style="padding-top:0px;padding-bottom:2px;padding-right:7px;"><a href="/<mm:node number="<%= rootID %>"><mm:field name="naam" /></mm:node>"><img src="../media/arrowleft_default.gif" border="0"></a></td>
