...
<mm:list nodes="<%= pageId %>"
	...
	<%	if(thisImage.equals("")) { thisImage = images_number; }
		...
		if(thisImage.equals(images_number)) { previousImage = lastImage; } // thisImage found in present loop; set previousImage
