...
<mm:present referid="product"><a href="#product" class="subtitle"><mm:write referid="product" /></a><br></mm:present>
...
<mm:list nodes="<%= shop_itemId %>" path="items,posrel,artikel" orderby="posrel.pos" directions="UP">
	<a href="#<mm:field name="artikel.number" />" class="subtitle"><mm:field name="artikel.titel_fra" /><br>
</mm:list>
</td></tr>
