		...
		%><tr>
			<td class="cart<%= rowParity %>" style="text-align:left;padding-right:0px;padding-left:5px;">
				<a href="javascript:changeIt('<mm:url page="<%= pageUrl + "&u=" + thisShop_item %>" 
					/>');" onclick="needToConfirm = false;"><mm:field name="title" /></a><br>
			</td>
   	   ...
   	   <% } %>
   		<td class="cart<%= rowParity %>"><a href="javascript:changeIt('<mm:url
				page="<%= pageUrl + "&p=bestel&u=" + thisShop_item + "&t=delete" %>" />');" onclick="needToConfirm = false;"
   ...
   <tr>
   	...
   	<td class="carteven" style="padding:0px;padding-top:1px;">
   		<table cellspacing="0" cellpadding="0" width="100%">
   			...
   			<td style="vertical-align:middle;"><a href="javascript:changeIt('<mm:url 
   				page="<%= pageUrl + "&p=bestel&t=change" %>" />');document.shoppingcart.target='';document.shoppingcart.submit();" onclick="needToConfirm = false;">
...
{	if (window.event.keyCode == 13) {
         needToConfirm = false;
         changeIt('<mm:url page="<%= pageUrl + "&p=bestel&t=change" %>" />');
   }
} 
<%= "//-->" %>
</script> 
