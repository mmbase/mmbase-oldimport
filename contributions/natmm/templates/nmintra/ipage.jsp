...
if(!paginaID.equals("-1")) { 
    ...
    if(!template_url.equals("")) { 
            %><jsp:include page="<%= template_url + "?p=" + paginaID + "&category=" + categoryId %>" 
            ></jsp:include><% 
            
    } else {
    
        %><td colspan="2"><b><font color="#CC0000">Error:</font></b><br>Er moet nog een template gekoppeld worden aan de '<mm:node number="<%= paginaID 
