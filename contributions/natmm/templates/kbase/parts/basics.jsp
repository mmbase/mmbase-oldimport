...
<%!
  ...
  /*
  *Deze methode geeft het volledige pad terug naar de locatie van de kabase op de server. Om links naar plaatjes
...
><mm:import id="addananswertothisquestion">voeg een antwoord toe op deze vraag</mm:import
><mm:import id="answerstothisquestion">antwoorden op deze vraag</mm:import
><mm:import id="editcurrentquestion">bewerk deze vraag</mm:import
><mm:import id="addaquestion">voeg een vraag toe</mm:import
><mm:import id="editcurrentfolder">bewerk deze map</mm:import
><mm:import id="createnewfolderincurrentone">maak een nieuw map aan onder de huidige</mm:import
><mm:import id="choosenewparentfolder">kies een nieuwe map</mm:import
><mm:import id="visible">zichtbaar</mm:import
><mm:import id="edit">Bewerk bestaande</mm:import
><mm:import id="add">Nieuwe</mm:import
><mm:import id="commit">Opslaan</mm:import
><mm:import id="cancel">Annuleren</mm:import
><mm:import id="answer">antwoord</mm:import
><mm:import id="question">vraag</mm:import
><mm:import id="category">map</mm:import
><mm:import id="markupexplanation">Door &lt;b&gt; .. &lt;/b&gt; of &lt;i&gt; .. &lt;/i&gt; kan de tekst worden opgemaakt.</mm:import
><mm:import id="rooteditwarning">De root map kan niet worden bewerkt.</mm:import
><mm:import id="roottitle">klik hier om de vragen te bekijken</mm:import
><mm:import id="removeaquestion">deze vraag verwijderen</mm:import
