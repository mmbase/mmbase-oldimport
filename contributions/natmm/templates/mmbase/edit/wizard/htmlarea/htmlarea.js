...
HTMLArea.Config = function () {
        ...
        // style included in the iframe document *** hh: changed font-family of body ***
        this.pageStyle = "body { background-color: #fff; font-size: 12px; font-family: verdana,sans-serif; } p { margin: 0px; }";
