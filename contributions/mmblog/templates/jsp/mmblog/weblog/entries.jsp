...
<tr>
	...
	<mm:constraint field="weblogs.number" operator="EQUAL" value="$weblogid" />
	    <mm:list>
            <tr>
	    <td><a href="<mm:url page="index.jsp" referids="main,weblogid"><mm:param name="sub">entry</mm:param><mm:param name="weblogentryid"><mm:field name="weblogentries.number" /></mm:param><mm:param name="webrelid"><mm:field name="weblogrel.number" /></mm:param></mm:url>"><mm:field name="weblogentries.title" /></a></td>
            </tr>
	    </mm:list>
	</mm:listcontainer>
        <tr>
