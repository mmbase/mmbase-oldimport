...
<tr>
  ...
  <mm:nodelistfunction set="mmbar" name="getMixedTests">
  <tr>
	<th>
	<mm:field name="name" />
	</th>
	...
	<td width="100" align="center">
	<input type="hidden" value="mixedtest" name="sub" />
	...
	<form action="<mm:url page="index.jsp" referids="main" />" method="post">
	<td width="100" align="center">
	<input type="hidden" value="performmixedtest" name="action" />
	<input type="hidden" value="<mm:field name="name" />" name="name" />
...
function refresh()
{
    window.location.href ='index.jsp?main=mixed';
}
//-->
</script>
	<table cellpadding="0" cellspacing="0" class="list" style="margin-top : 2px;" width="55%">
