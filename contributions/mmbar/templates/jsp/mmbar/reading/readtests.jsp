...
<mm:present referid="action">
 <mm:include page="reading/actions.jsp" />
</mm:present>
<!-- end action check -->
...
<tr>
  ...
  <mm:nodelistfunction set="mmbar" name="getReadTests">
  <tr>
	<th>
	<mm:field name="name" />
	</th>
	...
	<td width="100" align="center">
	<input type="hidden" value="readtest" name="sub" />
	...
	<form action="<mm:url page="index.jsp" referids="main" />" method="post">
	<td width="100" align="center">
	<input type="hidden" value="performreadtest" name="action" />
	<input type="hidden" value="<mm:field name="name" />" name="name" />
...
function refresh()
{
    window.location.href ='index.jsp?main=reading';
}
//-->
</script>
	<table cellpadding="0" cellspacing="0" class="list" style="margin-top : 2px;" width="55%">
