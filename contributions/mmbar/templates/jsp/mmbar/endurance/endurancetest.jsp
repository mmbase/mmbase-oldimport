...
<mm:present referid="action">
 <mm:include page="endurance/actions.jsp" />
</mm:present>
<!-- end action check -->

<mm:import externid="name" />

<mm:nodefunction set="mmbar" name="getEnduranceTest" referids="name">
...
<tr>
	<th colspan="4">
	Endurancetest : <mm:field name="name" />
	</th>
</tr>
<tr>
	<td colspan="4">
...
<mm:nodelistfunction set="mmbar" name="getEnduranceTestBenchmarks" referids="name">
<tr>
