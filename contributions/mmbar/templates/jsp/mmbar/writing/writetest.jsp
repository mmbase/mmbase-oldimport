...
<mm:nodefunction set="mmbar" name="getWriteTest" referids="name">
...
<mm:nodelistfunction set="mmbar" name="getWriteTestBenchmarks" referids="name">
<tr>
