 ...
 */
package org.mmbase.applications.mmbar.mixedtests;
 ...
 */
public class NodeBridgeMixedTest extends MixedTest {

    // logger
    private static Logger log = Logging.getLoggerInstance(NodeBridgeMixedTest.class);
    ...
    public void testRun() {
        ...
        if (nm == null) {
            ...
            try {
                ...
                log.error("Error inside NodeBridgeMixedTest");
            }
