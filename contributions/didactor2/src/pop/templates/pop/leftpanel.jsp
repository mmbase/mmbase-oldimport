...
<mm:compare referid="whatselected" value="0">
  ...
  <select name="wgroup" class="popteacherformselect" onChange="teacherform.whatselected.value='wgroup';teacherform.submit()">
    <option value=0>alle werkgroepen</option>
...
<br/>
<br/>
<input type="button" class="formbutton" onClick="teacherform.whatselected.value='student';teacherform.submit()" value="zoek"> 
<input type="button" class="formbutton" onClick="teacherform.whatselected.value='0';teacherform.submit()" value="wis"> 
</form>
<br/>
<br/>
