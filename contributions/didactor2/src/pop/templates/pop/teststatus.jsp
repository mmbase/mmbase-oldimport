<%--<%@taglib uri="http://www.mmbase.org/mmbase-taglib-1.1" prefix="mm" %><%@taglib uri="http://www.didactor.nl/ditaglib_1.0" prefix="di" %><mm:content postprocessor="reducespace" expires="0">
...
--%>
              ...
              <mm:import id="goodanswers" reset="true"><%= good %></mm:import>
              <mm:import id="falseanswers" reset="true"><%= bad %></mm:import>
