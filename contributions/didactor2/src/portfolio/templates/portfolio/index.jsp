...
<mm:cloud method="delegate" authenticate="asis">
  ...
  <mm:locale language="$language">
    ...
    <mm:present referid="action_move">
      <mm:redirect page="/portfolio/moveitems.jsp" referids="$referids,currentfolder,ids,typeof,contact?">
        <mm:param name="callerpage">/portfolio/index.jsp</mm:param>
      </mm:redirect>
    </mm:present>
      ...
      <div class="folders">
        ...
        <div class="folderBody">
          ...
          <mm:compare referid="mayeditfolders" value="true">
            <mm:compare referid="typeof" value="-1" inverse="true">
              <a href="<mm:treefile page="/portfolio/createfolder.jsp" objectlist="$includePath" referids="$referids,contact?,currentfolder,typeof">
                <mm:param name="callerpage">/portfolio/index.jsp</mm:param>
                </mm:treefile>">
            ...
            <mm:isgreaterthan referid="currentfolder" value="0">
              <a href="<mm:treefile page="/portfolio/changefolder.jsp" objectlist="$includePath" referids="$referids,contact?,currentfolder,typeof">
                <mm:param name="callerpage">/portfolio/index.jsp</mm:param>
                </mm:treefile>">
              ...
              <a href="<mm:treefile page="/portfolio/deletefolder.jsp" objectlist="$includePath" referids="$referids,contact?,currentfolder,typeof">
                <mm:param name="callerpage">/portfolio/index.jsp</mm:param>
                </mm:treefile>">
            ...
            <br /><br /><!-- br's are no go, 2 br's are evil -->
          ...
          <a href="index.jsp?contact=<mm:write referid="contact"/>"><di:translate key="portfolio.folder_cockpit" /></a>
          <br/>
        ...
        <div class="contentSubHeader">
          ...
          <mm:isgreaterthan referid="currentfolder" value="0">
            <mm:compare referid="mayeditentries" value="true">
              <a href="<mm:treefile page="/portfolio/adddocument.jsp" objectlist="$includePath" referids="$referids,contact?,currentfolder,typeof">
                <mm:param name="callerpage">/portfolio/index.jsp</mm:param>
                </mm:treefile>">
              ...
              <a href="<mm:treefile page="/portfolio/addurl.jsp" objectlist="$includePath" referids="$referids,contact?,currentfolder,typeof">
                <mm:param name="callerpage">/portfolio/index.jsp</mm:param>
                </mm:treefile>">
              ...
              <di:table maxitems="10">
                ...
                <mm:listnodes>
                  ...
                  <di:row>
                    ...
                    <mm:import id="link"><a href="<mm:treefile page="/portfolio/showitem.jsp" objectlist="$includePath" referids="$referids,contact,currentfolder,typeof">
    ...
    <div class="contentBodywit">
      ...
      <mm:compare referid="edit" value="true" inverse="true">
        ...
        <mm:node referid="myuser">
          ...
          <!-- wtf, table in table, class=Font, not much is actually digestable code -->
          <table class="Font">
            <tr>
              <td>
                <table class="Font">
