...
<div class="navigationbar">
  <div class="titlebar">
      <img src="<mm:treefile write="true" page="/gfx/icon_shareddocs.gif" objectlist="$includePath" referids="$referids"/>" width="25" height="13" border="0" title="<di:translate key="workspace.projectgroups" />" title"<di:translate key="workspace.projectgroups" />" alt="<di:translate key="workspace.projectgroups" />" />
