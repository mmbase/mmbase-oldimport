...
<mm:cloud method="delegate" jspvar="cloud">
   ...
   <mm:present referid="education">
      ...
      <div class="menuSeperator"> </div>
      <div class="menuItem">
         <a href='<mm:url referids="provider,education,class" page="../assessment/mail_to_coach.jsp"/>' class="menubar"><di:translate key="assessment.education_menu_item_mail_to_coach" /></a>
      </div>
   </mm:present>
