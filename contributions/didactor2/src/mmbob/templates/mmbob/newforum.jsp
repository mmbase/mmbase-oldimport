...
<table cellpadding="0" cellspacing="0" class="list" style="margin-top : 50px;" width="75%">
  <tr><th colspan="3"><fmt:message key="CreateNewForum"/></th></tr>
  ...
  <form action="<mm:url page="forums.jsp">
    ...
    <tr><th><fmt:message key="AdminAccount"/></th><td colspan="2">
    <input name="account" size="70" value="" style="width: 100%">
    </td></tr>
    <tr><th><fmt:message key="AdminPassword"/></th><td colspan="2">
