  ...
  <mm:present referid="addavatar">
    <mm:transaction name="avatartrans">
      ...
      <mm:createnode id="avatarnode" type="images">
        <mm:setfield name="title"><fmt:message key="UploadedAvatar"/> (<mm:write referid="_handle_name"/>)</mm:setfield>
      ...
      <mm:notpresent referid="userset">
        <mm:createnode id="userset" type="avatarsets">
          <mm:setfield name="name"><mm:node referid="posterid"><mm:field name="account"/></mm:node> <fmt:message key="set"/></mm:setfield>
        </mm:createnode>
...
<html <%-- hh xmlns="http://www.w3.org/1999/xhtml" --%>>
  <head>
    <title><fmt:message key="ForumProfile"/></title>
...
<table cellpadding="0" cellspacing="0" class="list" style="margin-top : 10px;" width="95%">
    ...
    <div id="profileb">
      ...
      <ul>
        ...
        <mm:param name="profile" value="$profile" />
        </mm:url>"><fmt:message key="ownAvatars"/></a>
        </li>
        ...
        <mm:param name="selectedavatar" value="true " />
        <mm:param name="profile" value="$profile" />
        </mm:url>"><fmt:message key="otherAvatars"/></a>
        </li>
      </ul>
    </div>
    ...
    <div id="profile">
          ...
          <mm:relatednodescontainer type="avatarsets">
            ...
            <mm:relatednodes>
              <mm:first>
                ...
                <span class="label"><fmt:message key="SelectCategory"/>:</span>
                <span class="formw">
     ...
     <mm:notpresent referid="headdisplayed">
       <span class="label"><fmt:message key="NoAvatars"/></span>
