<mm:context id="temp">
  <mm:node number="$user" notfound="skip">
    ...
    <mm:functioncontainer set="mmbob" name="createPoster">
      ...
      <mm:param name="firstname"><mm:field name="firstname" /></mm:param>
      <mm:param name="lastname"><mm:field name="lastname" /></mm:param>
      <mm:param name="email"><mm:field name="email" /></mm:param>
...
<mm:log>found forumid: ${forumid} posterid: ${posterid}</mm:log>
