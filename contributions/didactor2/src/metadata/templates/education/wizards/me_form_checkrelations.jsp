...
<mm:related  path="posrel,metadefinition" constraints="<%= "posrel.pos='" + CONSTRAINT_FORBIDDEN + "'" %>"
  searchdir="source" fields="metadefinition.number" >
...
if(bCheckRelations) {
   ...
   %>
   <mm:related path="posrel,metavocabulary" constraints="<%= "posrel.pos='" + CONSTRAINT_FORBIDDEN + "'" %>"
      searchdir="source" fields="metavocabulary.number" >
