...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
     ...
     <td><nobr>&nbsp;<a href='<mm:write referid="listjsp"/>&wizard=config/cmsnews/rootnewsnodes&origin=<mm:write referid="newscontainernode"/>&nodepath=newsnodes&fields=name&metadata=yes' title="Nieuws" target="text">Nieuws</a></nobr></td> 
  </tr>
</table>
...
<% int nbc = 0; %> 
			<table border="0" cellpadding="0" cellspacing="0">
			   <tr>
			      ...
			      <td><nobr>&nbsp;<a href='<mm:write referid="wizardjsp"/>&wizard=config/cmsnews/rootnewsnodes&origin=<mm:write referid="newscontainernode"/>&objectnumber=new' title="nieuwe nieuws categorie" target="text">nieuwe nieuws categorie</a></nobr></td>
			   </tr>
			</table>    
	   <mm:listnodes type="newscontainers">
	              ...
	              <mm:relatednodes>
	                  ...
	                  <% childHasChilds = false; %>
			              ...
			              <tr>	                    
												...
												<td><a href='<mm:write referid="wizardjsp"/>&wizard=config/cmsnews/newsnodes&objectnumber=<mm:field name="number"/>' title="edit" target="text"><mm:field name="name"/></a></td>																								
										</tr>	
										</table>	
												...
												<mm:node number="$this">
														...
														<table border="0" cellpadding="0" cellspacing="0">
														   <tr>
														      ...
														      <%}%>														      
														      <td><img src="gfx/new_education.gif" width="16" border="0" align="middle" /></td>
														      <td><nobr>&nbsp;<a href='<mm:write referid="wizardjsp"/>&wizard=config/portalpages/newsimplecontents&origin=<mm:write referid="this"/>&objectnumber=new' title="nieuwe nieuws item" target="text">nieuwe nieuws item</a></nobr></td>
														   </tr>
														</table> 																																																																													
												    <%levelTwoLast = false; %>
