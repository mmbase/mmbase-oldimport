    ...
    <div class="contentBodywit">
      ...
      <mm:notpresent referid="showfeedback">
        <div style="float: right">
          <a href="<mm:treefile page="/portfolio/index.jsp" objectlist="$includePath" referids="$referids"><mm:param name="contact"><mm:write referid="student"/></mm:param></mm:treefile>">
             <img src="<mm:treefile page="/progress/gfx/portfolio.gif"  objectlist="$includePath" referids="$referids"/>"
          ...
          <mm:islessthan inverse="true" referid="rights" referid2="RIGHTS_RW">
            <a href="<mm:treefile page="/progress/index.jsp" objectlist="$includePath" referids="$referids"/>">
              <img src="<mm:treefile page="/progress/gfx/back.gif"  objectlist="$includePath" referids="$referids"/>"
