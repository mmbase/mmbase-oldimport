...
<mm:content postprocessor="reducespace" expires="0">
  <mm:cloud method="delegate" >
    ...
    <div class="rows">
      ...
      <div class="folders">
        ...
        <div class="folderBody">
          ...
          <a href="<mm:treefile page="/email/changemailbox.jsp" objectlist="$includePath" referids="$referids">
            ...
            <img src="<mm:treefile page="/email/gfx/map hernoemen.gif" objectlist="$includePath" referids="$referids"/>" border="0" title="<di:translate key="email.renamefolder" />" alt="<di:translate key="email.renamefolder" />"/>
          </a>
          ...
          <a href="<mm:treefile page="/email/deletemailbox.jsp" objectlist="$includePath" referids="$referids">
            ...
            <img src="<mm:treefile page="/email/gfx/verwijder map.gif" objectlist="$includePath" referids="$referids"/>" border="0" title="<di:translate key="email.deletefolder" />" alt="<di:translate key="email.deletefolder" />"/>
          </a>
      ...
      <form action="<mm:treefile page="/email/index.jsp" objectlist="$includePath" referids="$referids,so?,sf?"/>" method="POST">
        ...
        <div class="mainContent">
          ...
          <mm:present referid="mailboxname">
            <div class="contentSubHeader">
              ...
              <a href="<mm:treefile page="/email/mailrule.jsp" objectlist="$includePath" referids="$referids,so?,sf?"/>"><img src="<mm:treefile page="/email/gfx/mail_rule.gif" objectlist="$includePath" referids="$referids"/>" title="<di:translate key="email.mailrules" />" alt="<di:translate key="email.mailrules" />" border="0">
              </a>                  
            </div>
