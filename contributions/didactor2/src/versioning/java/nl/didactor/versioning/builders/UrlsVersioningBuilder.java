...
public class UrlsVersioningBuilder extends org.mmbase.module.builders.Urls
{

  private static Logger log = Logging.getLoggerInstance(UrlsVersioningBuilder.class.getName());
  private Cloud cloud;
