...
public class AttachmentsVersioningBuilder extends org.mmbase.module.builders.Attachments
{

  private static Logger log = Logging.getLoggerInstance(AttachmentsVersioningBuilder.class.getName());
  private Cloud cloud;
