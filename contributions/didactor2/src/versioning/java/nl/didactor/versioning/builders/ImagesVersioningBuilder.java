...
public class ImagesVersioningBuilder extends org.mmbase.module.builders.Images
{

  private static Logger log = Logging.getLoggerInstance(ImagesVersioningBuilder.class.getName());
  private Cloud cloud;
