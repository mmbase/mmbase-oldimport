				...
				<mm:node number="$thischild">
						<table border="0" cellpadding="0" cellspacing="0">
						   <tr>
						      ...
						      <td><nobr>&nbsp;<a href='<mm:write referid="wizardjsp"/>&wizard=config/portalpages/newsimplecontents&origin=<mm:write referid="thischild"/>&objectnumber=new' title="nieuwe content" target="text">nieuwe content</a></nobr></td>
						   </tr>
						</table>				
						<mm:listcontainer path="portalpagesnodes,related,simplecontents">
