...
<mm:node number="component.assessment">
   <mm:node number="$learnobject" jspvar="nodeLearnObject">
      <mm:related path="descriptionrel,learnblocks" searchdir="destination">
         <a href="<mm:url referids="provider,education,class" page="../index.jsp">
             ...
             </mm:url>" target="_TOP" style="text-decoration:none">
            <table border="1" cellpadding="0" cellspacing="0" width="70%" style="color:#FFFFFF;background:#949494;" >
               <tr>
                  <td width="0px">
                     <mm:node element="learnblocks">
