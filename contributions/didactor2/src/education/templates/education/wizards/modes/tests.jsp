              ...
              <li>
                <span class="folder">
                  <mm:link referid="listjsp">
                    ...
                    <!-- ${forbidtemplate} ??-->
                    <a href="${_}"><di:translate key="education.tests" /></a>
                  </mm:link>
                </span>
                <ul>
                  <li>
                    <mm:link referid="wizardjsp">
                      ...
                      <di:translate key="education.createnewtest" /></a>
                    </mm:link>
                  </li>
                    ...
                    <li>
                      <span class="folder">
                        <mm:link referid="wizardjsp" referids="_node@objectnumber">
                          ...
                          <a href="${_}"
                             title="${di:translate('education.treattest')}"><mm:field name="name" /></a>
                        </mm:link>
                        <mm:hasnode number="component.metadata">
                          <mm:link page="metaedit.jsp" referids="_node@number">
                            <a href="${_}">
                              <img id="img_${_node}" src="${imageName}" border="0" title="${sAltText}" alt="${sAltTex}" />
                            </a>
                          </mm:link>
                        </mm:hasnode>
                      </span>
