      ...
      <form name="meta_form">
         ...
         <div align="center" style="position:absolute; bottom:0px">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="0" style="height:0px">
               <tr>
                  <td align="right"><input type="reset" name="command" value="Annuleren" class="special_buttons" style="width:90px" onClick="document.location.href='menu.jsp'"/></td>
                  <td>-</td>
                  <td><input type="submit" name="command" value="Opslaan en beëindigen" class="special_buttons" style="width:200px" /></td>
                  <td>-</td>
                  <td><input type="submit" name="command" value="Opslaan" class="special_buttons" style="width:80px" /></td>
               </tr>
            </table>
         </div>
      </form>
