...
<mm:cloud jspvar="cloud" method="asis">
   ...
   <fmt:bundle basename="nl.didactor.component.education.EducationMessageBundle">
      ...
      <body onLoad="try{top.frames['menu'].location.reload();  top.frames['code'].location.reload()} catch(err){};">
         <table height="23" border="0" cellpadding="0" cellspacing="0" class="titlefield2" style="width:965px; background:#DEDEDE;">
            <form>
               ...
               <tr>
                  ...
                  <td                                         <mm:compare referid="education_top_menu" value="educations">     class="education_top_menu_selected" </mm:compare>>
                     <%
