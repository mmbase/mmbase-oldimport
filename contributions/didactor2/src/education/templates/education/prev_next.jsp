...
<mm:cloud method="delegate">
  ...
  <jsp:directive.include file="/shared/globalLang.jspx" /> <!-- oh no, why does di:translate not work with mm:locale or mm:content or so?, this would not have been needed -->
  <p>
