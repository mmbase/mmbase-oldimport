...
<mm:cloud method="asis">
  ...
  <p>
    ...
    <img src="${mm:url('/gfx/spacer.gif', pageContext)}" width="15" height="1" title="" alt="" /><a href="javascript:parent.nextContent();" class="path"><di:translate key="education.next" /></a>
