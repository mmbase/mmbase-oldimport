      ...
      <div class="block">
        <div class="content">
          ...
          <div class="item">
            ...
            <c:choose>
               <c:when test="${fn:length(intro) > 100}">
                  ${fn:substring(intro, 0, 100)}...
               </c:when>
               <c:otherwise>
                  ${intro}
               </c:otherwise>
            ...
            <c:if test="${fn:length(intro) == 0}">
              ...
              <cmsc:removehtml var="cleanbody" maxlength="100" html="${body}"/>
               ...
               <c:choose>
                  <c:when test="${fn:length(cleanbody) > 100}">
                     ${fn:substring(cleanbody, 0, 100)}... 
                  </c:when>
                  <c:otherwise>
                     ${cleanbody}
                  </c:otherwise>
            ...
            <div>
              <a href="${renderUrl}" class="readon">
                ...
                <img alt="" src="<cmsc:staticurl page='/gfx/arrow_link_${imagePostfix}.gif'/>" />
              </a>
            </div>
