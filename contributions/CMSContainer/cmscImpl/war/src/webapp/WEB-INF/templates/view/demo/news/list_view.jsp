...
<mm:cloud method="asis">
	<mm:node number="${elementId}">					
      ...
      <c:choose>
         <c:when test="${not empty showExpanded and elementIndex lt showExpanded}">
            ...
            <div class="item" style="${textStyle}"><h2><a href="${renderUrl}">${elementTitle}</a></h2>
               ...
               <a href="${renderUrl}" class="readon"><fmt:message key="view.readon" /><img alt="" src="<cmsc:staticurl page='/gfx/arrow_link_${imagePostfix}.gif'/>" /></a></p>
            </div>
            <div class="clear"></div>
