...
public class PagerTag extends TagSupport {
   ...
   /*
    * The encoding of the parameters in the URL is set to ISO, because tomcat
    * does not want to understand other kinds of encoding in the URL. (at least
    * till version 5.5.17).
    */
   ...
   public int doStartTag() throws JspException {
      ...
      String offsetParam = pageContext.getRequest().getParameter(idOffsetParam);
      if (offsetParam != null) {
         try {
