...
<%-- keep track of preference --%>
  ...
  <% if ("top".equals(position) || "both".equals(position)) { %>
    ...
    <pg:index>
  	...
  	<jsp:include page="texticon.jsp" flush="true"/>
      <% } else if ("jsptags".equals(style)) { %>
  	<jsp:include page="jsptags.jsp" flush="true"/>
      <% } else if ("google".equals(style)) { %>
  	<jsp:include page="google.jsp" flush="true"/>
      <% } else if ("altavista".equals(style)) { %>
  	<jsp:include page="altavista.jsp" flush="true"/>
      <% } else if ("lycos".equals(style)) { %>
  	<jsp:include page="lycos.jsp" flush="true"/>
      <% } else if ("yahoo".equals(style)) { %>
  	<jsp:include page="yahoo.jsp" flush="true"/>
      <% } else if ("alltheweb".equals(style)) { %>
