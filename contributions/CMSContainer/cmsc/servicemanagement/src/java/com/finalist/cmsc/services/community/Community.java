...
public class Community {
	private final static CommunityService cService = 
    ...
    public static boolean logoutUser(/**HttpServletRequest HttpRequest, **/ActionRequest request, ActionResponse response) {
    	return cService.logoutUser(/**HttpRequest, **/request, response);
    }
}
