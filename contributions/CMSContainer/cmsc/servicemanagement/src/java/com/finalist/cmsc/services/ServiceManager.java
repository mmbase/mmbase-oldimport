 ...
 * {@link org.apache.pluto.portalImpl.services.Service} interface if they are to
 * be used with the portal driver.
 * <P>
 ...
 * implementation or abstract class of the service, without the leading package
 * name. For example, the service manager looks for
 * <CODE>LoggerImpl .properties</CODE>. This allows a special implementation
 * to provide different configuration than the general (abstract) service
 * requires.
 * <P>
...
public class ServiceManager {
    ...
    * By specifying a different implementation of the service the behaviour * of
    * the portal can be modified. * *
    * 
    * @param aConfig *
    *           the servlet configuration * *
    * @exception Exception *
    *               if loading <CODE>services.properties</CODE> * or
    ...
    *           The location of <CODE>services.properties</CODE> (relative to
    *           classpath) *
    * @param aServiceConfigDir *
    *           The direcory with the services' properties files (relative to
    *           classpath) * *
    * @exception Exception *
    *               if loading <CODE>services.properties</CODE> * or
    *               initializing any of its contained services fails
   ...
   public static void init(ServletConfig aConfig, String aServiceConfigFile, String aServiceConfigDir) throws Exception {
      ...
      for (Iterator<String> iter = props.names(); iter.hasNext();) {
         ...
         try {
            ...
            log.error("ServiceManager: A service implementation with name " + serviceImplName + " cannot be found.",
                  exc);
   ...
   public static void hotInit(ServletConfig aConfig, String aServiceConfigFile, String aServiceConfigDir,
         String theService) throws Exception {
      // avoid duplicate initialization of services
         ...
         if (serviceBaseName.equals(theService)) {
            ...
            try {
               ...
               try {
                  ...
                  is = context.getResourceAsStream(aServiceConfigDir + StringUtils.nameOf(serviceImpl) + ".properties");
                  if (is == null)
                     is = context.getResourceAsStream(aServiceConfigDir + StringUtils.nameOf(serviceBase)
                           + ".properties");
                  if (is != null)
                     serviceProps.load(is);
               }
