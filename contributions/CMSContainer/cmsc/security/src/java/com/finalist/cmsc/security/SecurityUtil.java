...
public class SecurityUtil {
   ...
   public static TreeMap<String, UserRole> getLoggedInRoleMap(Cloud cloud, String managerName, String relationName,
   ...
   public static TreeMap<String, UserRole> getLoggedInRoleMap(Cloud cloud, String[] treeManagers, String relationName,
         String[] fragmentFieldname) {

      String channelName = treeManagers[0];
      TreeMap<String, UserRole> channelsWithRole = (TreeMap<String, UserRole>) cloud.getProperty(CMSC_USERROLES
            + channelName);
   ...
   public static void getUserRoleMap(Node user, String[] treeManagers, String relationName, String[] fragmentFieldname,
   ...
   /**
    * Fills a Map with the role for the channels with a rolerel to the given
    * group.
    * 
    * @param group
    *           Node of group
    * @param channelsWithRole
    *           Map to fill with roles
    * @param treeManagers
    *           managers used in the tree
    * @param relationName
    *           relation between the managers
    * @param fragmentFieldname
    *           fieldname the path is constructed with
    */
   public static void fillChannelsWithRole(Node group, TreeMap<String, UserRole> channelsWithRole,
      ...
      for (int i = treeManagers.length - 1; i >= 0; i--) {
         ...
         if (cloud.hasRelationManager(GROUP, managerName, ROLEREL)) {
            ...
            NodeList channelNodeList = cloud.getList(null, managerName + "," + ROLEREL + "," + GROUP, ROLEREL + "."
                  + ROLE_FIELD + ", " + managerName + "." + NUMBER_FIELD, "[" + GROUP + "." + NUMBER_FIELD + "] = "
                  + group.getNumber(), null, null, null, true);
            ...
            while (nodeIterator.hasNext()) {
               ...
               // no path found for this channel in cache retrieve it from
               // mmbase
               String path = TreeUtil.getPathToRootString(channelNode, treeManagers, relationName, fragmentFieldname,
                     true);
   ...
   public static void addRole(Node group, Node channelNode, Role role) {
      ...
      RelationManager rolemanager = group.getCloud().getRelationManager(GROUP, channelNode.getNodeManager().getName(),
            ROLEREL);
   ...
   public static TreeMap<String, UserRole> getRoleMap(String[] treeManagers, String relationName,
         String[] fragmentFieldnames, Node group) {
   ...
   public static TreeMap<String, UserRole> getRoleMap(String managerName, String relationName,
         String fragmentFieldname, Node group) {
      String[] treeManagers = new String[] { managerName };
      String[] fragmentFieldnames = new String[] { fragmentFieldname };
   ...
   public static String getFullname(Node user) {
      ...
      return NameUtil.getFullName(user.getStringValue("firstname"), user.getStringValue("prefix"), user
            .getStringValue("surname"));
   }
   ...
   public static List<Node> getUsersWithRights(Node channel, Role requiredRole, String[] treeManagers,
         String relationName) {
      ...
      while (iter.hasNext()) {
         ...
         RelationManager rolerelManager = channel.getCloud().getRelationManager(GROUP,
               pathChannel.getNodeManager().getName(), ROLEREL);
