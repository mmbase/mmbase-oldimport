...
public class TasksUtil {
    ...
    public final static String STATUS_NOTIFIED = "notified";
    ...
    public static Node createUserTask(Cloud cloud, String title, String description, Date deadline, String nodetype, int user) {
    ...
    public static Node createExpireTask(Cloud cloud, String title, String description, Date deadline, Node userNode, String nodetype, Node node) {
        return createTask(cloud, title, description, deadline, TYPE_EXPIRE, STATUS_INIT, userNode, nodetype, node);
    }

    public static Node createTask(Cloud cloud, String title, String description, Date deadline, String type, String status, Node userNode, String nodetype, Node node) {
    ...
    public static long getLastTaskCreationTime(Cloud cloud, String type) {
        ...
        aggregate.addAggregatedField(query.getStep(TASK), taskManager.getField(CREATIONDATE), AggregatedField.AGGREGATION_TYPE_MAX);
