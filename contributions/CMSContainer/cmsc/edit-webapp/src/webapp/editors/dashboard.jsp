            ...
            <mm:listnodes>
              <mm:field name="number" write="false" id="number"/>
			   ...
			   <td>
					...
					<a href="javascript:window.top.openRepositoryWithContent('<mm:write referid="number"/>');"><img src="gfx/icons/edit.gif" alt="<fmt:message key="dashboard.content.edit" />" title="<fmt:message key="dashboard.content.edit" />" /></a>
