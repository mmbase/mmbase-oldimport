...
//	email :	fuushikaden@yahoo.com
    ...
    */
	...
	function closeCalendar() {
      ...
      formObject[tempFieldName].value = dateSelected +"-"+eval(monthSelected+1)+"-"+yearSelected;
