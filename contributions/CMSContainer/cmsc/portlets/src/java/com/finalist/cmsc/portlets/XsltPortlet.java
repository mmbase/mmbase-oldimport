...
public class XsltPortlet extends CmscPortlet {
    ...
    protected String transformXml(String xsl, String xml, HashMap<String, Object> xslParams) throws TransformerException,
                                ParserConfigurationException, SAXException, IOException, MalformedURLException {
