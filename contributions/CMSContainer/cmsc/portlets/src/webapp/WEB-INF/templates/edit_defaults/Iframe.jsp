...
<div class="portlet-config-canvas">
	<form name="<portlet:namespace />form" method="post" action="<cmsc:actionURL />" target="_parent">	
		<table class="editcontent">
			...
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.scrolling" />:</td>
				<td>
					<cmsc:select var="scrolling">
			...
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.frameBorder" />:</td>
				<td>
					<cmsc:select var="frameBorder">
			...
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.marginHeight" />:</td>
				<td><cmsc:text var="marginHeight" /></td>
			</tr>
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.marginWidth" />:</td>
				<td><cmsc:text var="marginWidth" /></td>
			</tr>
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.align" />:</td>
				<td>
					<cmsc:select var="align">
			...
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.style" />:</td>
				<td><cmsc:text var="style" /></td>
			</tr>
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.class" />:</td>
				<td><cmsc:text var="class" /></td>
			</tr>
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.id" />:</td>
				<td><cmsc:text var="id" /></td>
			</tr>
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.name" />:</td>
				<td><cmsc:text var="name" /></td>
			</tr>
			<tr>
				<td colspan="2"><fmt:message key="edit_defaults.usetable" />:</td>
				<td>
					<cmsc:select var="useTable">
