   ...
   @Override
    public ActionForward execute(ActionMapping mapping, ActionForm form,
      ...
      if (!Workflow.hasWorkflow(channelNode)) {
         Workflow.create(channelNode, resources.getMessage(locale, "content.move.workflow.message", elementNode.getNodeManager().getName(), elementNode.getStringValue("title")));
      }
