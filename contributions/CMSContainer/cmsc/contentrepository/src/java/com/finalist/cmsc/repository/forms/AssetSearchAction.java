...
public class AssetSearchAction extends PagerAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, Cloud cloud) throws Exception {
        ...
        SearchUtil.addDayConstraint(query, nodeManager, AssetElementUtil.CREATIONDATE_FIELD, searchForm
                .getCreationdate());
        queryStringComposer.addParameter(AssetElementUtil.PUBLISHDATE_FIELD, "" + searchForm.getPublishdate());
        SearchUtil
                .addDayConstraint(query, nodeManager, AssetElementUtil.PUBLISHDATE_FIELD, searchForm.getPublishdate());
        ...
        queryStringComposer
                .addParameter(AssetElementUtil.LASTMODIFIEDDATE_FIELD, "" + searchForm.getLastmodifieddate());
