...
public class ImageDeleteAction extends MMBaseFormlessAction {
   ...
   public ActionForward execute(ActionMapping mapping, HttpServletRequest request, Cloud cloud) throws Exception {
      ...
      return new ActionForward(mapping.findForward(SUCCESS).getPath() + "?&uploadedNodes=0&channelid=" + channelnumber + "&strict=" + strict, true);
   }
}
