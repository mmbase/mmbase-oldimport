      ...
      <div id="left">
      		<form action="SearchAction.do" name="searchForm" method="post" target="content">
         		...
         		<div class="side_block">
					...
					<div class="search_form"><input type="text" name="title" value="<fmt:message key="selector.search.term" />" onfocus="clearDefaultSearchText('<fmt:message key="selector.search.term" />');"/></div>
