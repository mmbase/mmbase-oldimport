      ...
      <html:form action="/editors/repository/SearchAction" method="post">
         ...
         <table>
            ...
            <tr>
               ...
               <td>
                  <html:select property="assettypes" onchange="selectContenttype('${searchinit}');" >
                     <html:option value="contentelement">&lt;<fmt:message key="searchform.assettypes.all" />&gt;</html:option>
      ...
      <mm:first>
         ...
         <mm:compare referid="action" value="link" inverse="true">
             <mm:hasrank minvalue="siteadmin">
               ...
               <div align="left"> <input type="button" class="button" name="massdelete" onclick="javascript:deleteContent('massdelete','<fmt:message key="recyclebin.massremoveconfirm"/>')" value="<fmt:message key="asset.delete.massdelete" />"/></div>
               </c:if>
              </mm:hasrank> 
         </mm:compare>
          <mm:compare referid="action" value="link" >
                     ...
                     <cmsc:hasfeature name="savedformmodule">
                        <c:set var="typeval">
                            ...
                            <c:if test="${typeval == 'responseform'}">
                               ...
                               <a href="<mm:write referid="showSavedForms"/>"><img src="../gfx/icons/application_form_magnify.png" title="<fmt:message key="asset.icon.savedform.title" />" alt="<fmt:message key="asset.icon.savedform.title" />"/></a>
                             </c:if>
                     </cmsc:hasfeature>
                  </mm:compare>
               </td>
              ...
              <img src="<cmsc:staticurl page="${channelIcon}"/>" align="top" alt="${channelIconMessage}" />
               ...
               <c:if test="${hasWorkflow}">
                  <td width="10" style="white-space: nowrap;">
                     ...
                     <img src="../gfx/icons/status_${status}.png" alt="<fmt:message key="asset.status" />: <fmt:message key="asset.status.${status}" />" title="<fmt:message key="asset.status" />: <fmt:message key="asset.status.${status}" />" />
                  </td>
                </c:if>
            </tr>
