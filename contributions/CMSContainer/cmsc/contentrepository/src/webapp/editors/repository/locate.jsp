...
<html:html xhtml="true">
   ...
   <body>
      <mm:cloud jspvar="cloud" loginpage="../../editors/login.jsp">
         ...
         <mm:import id="searchinit"><c:url value='/editors/repository/LocateInitAction.do'/></mm:import>
         <html:form action="/editors/repository/LocateAction" method="post">
                        ...
                        <tr onMouseOver="objMouseOver(this);"
                           ...
                           <td>
                              <% if (RepositoryUtil.hasCreationChannel(node)) { %>
                                 ...
                                 <% if (cc != null) { %>
                                       <a href="Navigator.do?channel=<%= cc.getNumber() %>" target="channels">
                           ...
                           <td style="padding:0px" align="right">
                              <a href="<mm:url page="../WizardInitAction.do">
                                       ...
                                       </mm:url>" title="<fmt:message key="locate.edit" />">
                                  <img src="../img/edit.gif" alt="<fmt:message key="locate.edit" />"/>
                              </a>
                           </td>
                           <td style="padding:0px" align="right">
                              <a href="#" onClick="showItem(<mm:field name="number"/>);" title="<fmt:message key="locate.showitem" />">
                                 <img src="../img/details.gif" alt="<fmt:message key="locate.showitem" />" />
                              </a>
                           </td>
                           <td style="padding:0px" align="right">
                              <a href="#" onClick="showChannels(<mm:field name="number"/>);" title="<fmt:message key="locate.showchannels" />">
                                 <img src="../img/tree.gif" alt="<fmt:message key="locate.showchannels" />" />
                              </a>
                           </td>
                        </tr>
                    </mm:node>
