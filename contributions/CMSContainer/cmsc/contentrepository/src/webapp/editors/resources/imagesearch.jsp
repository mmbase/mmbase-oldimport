...
<cmscedit:head title="images.title">
   ...
   function doCancleIt(){
	...
	function selectChannel(channelid, path) {
	    document.location = "../../repository/HighFrequencyImg.do?action=often&offset=0&channelid="+channelid;
	}
</script>
...
<mm:import externid="action">search</mm:import><%-- either often or search --%>
   ...
   `  </div>
      ...
      <mm:url page="/editors/repository/HighFrequencyImg.do?action=often&offset=0&channelid=all" id="often_show_images" write="false"/>
		<ul class="shortcuts">
