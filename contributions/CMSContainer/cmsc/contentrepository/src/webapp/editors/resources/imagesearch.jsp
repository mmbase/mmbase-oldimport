...
<%@include file="../repository/searchpages.jsp" %>
         ...
         <table border="0" width="100%" class="listcontent">
            <tr class="listheader">
               ...
               <th style="width: 100px;" nowrap="true"><a href="#" class="headerlink" onclick="orderBy('title');"><fmt:message key="imagesearch.titlecolumn" /></a></th>
               <th style="width: 110px;"><fmt:message key="imagesearch.filenamecolumn" /></th>
               <th style="width: 110px;"><fmt:message key="imagesearch.mimetypecolumn" /></th>
            </tr>
