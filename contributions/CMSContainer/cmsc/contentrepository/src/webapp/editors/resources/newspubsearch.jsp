   ...
   <cmscedit:head title="newspubs.title">
      ...
      <script>
         function showInfo(objectnumber,returnUrl) {
            openPopupWindow('newsletterpublication Info', '500', '500', 'newspubinfo.jsp?objectnumber='+objectnumber+'&returnUrl='+returnUrl);
         }
      </script>
   </cmscedit:head>
   <body>
         ...
         <div class="editor" style="height:500px">
            <div class="body">
               <mm:import id="searchinit">
                  <c:url value='/editors/resources/NewletterPublicationInitAction.do'/>
               </mm:import>
               <html:form action="/editors/resources/NewletterPublicationAction" method="post">
                        ...
                        <mm:listnodes referid="results">
                           <tr <c:if test="${useSwapStyle}">class="swap"</c:if>>
                              <td style="white-space:nowrap;">
                                 ...
                                 <c:choose>
                                    <c:when test="${status ne 'DELIVERED'}">
                                       <a href="<mm:url page="../WizardInitAction.do">
                                          ...
                                          <mm:param name="returnurl" value="<%="../editors/resources/NewletterPublicationAction.do" + request.getAttribute("geturl")%>" /> </mm:url>">
                                 ...
                                 <a href="javascript:showInfo(<mm:field name="number" />,'<%="/editors/resources/NewletterPublicationAction.do" + request.getAttribute("geturl")%>')">
