...
public class RelationshipLoader {
   ...
   /**
    * The locale which will be used for all created parent bundles.
    * If this is left null, the default locale is used.
    */
   private Locale locale = null;

   /**
    * The class loader which will be used for all created parent
    * bundles.  If this is left null, the system class loader is used.
    */
   ...
   /**
    * The file extensions which is searched on to obtain
    * the relationships file.
    */
   public static final String FILE_EXTENSION = ".relationships";

   /**
    * The character which is used to replace the '.' character in
    * resource names.
    */
   ...
   /**
    * The string which denotes a comment in the relationships
    * file.
    */
    ...
    * @param loader the class loader.  This is optional.  If no class
    * loader is specified, the system class loader is used.
    */
   protected RelationshipLoader(String baseName, Locale locale, 
                                ClassLoader loader) {
   ...
   /**
    * Retrieves the relationships file from the given ClassLoader
   ...
   private Enumeration getRelationshipNames() {
      ...
      try {
         ...
         if (is == null) return retVal.elements();
