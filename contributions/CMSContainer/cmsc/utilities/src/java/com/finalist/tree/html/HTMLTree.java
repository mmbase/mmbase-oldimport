...
public abstract class HTMLTree extends Tree {
   ...
   * @param expand - boolean, true if a node has children and is expanded
   */
   ...
   protected void renderNode(Object node, int level, PrintWriter out, String base, String preHtml, String myImg, boolean isLast) {
   ...
   protected abstract void renderChild(int level, PrintWriter out, String base, String preHtml, int count, int i, Object child);
