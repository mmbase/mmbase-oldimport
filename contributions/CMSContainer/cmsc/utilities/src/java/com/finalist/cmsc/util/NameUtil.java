...
/** NameHelper provides basic functionality to standardize the building of a full name-String
  * from the firstname and/or middlename and/or lastname of a person in several nameformats.
  */
public class NameUtil {
   /** Use this value to indicate the nameformat to use is 'firstname middlename lastname' (default). */
   public final static int NAMEFORMAT_FIRSTMIDDLELAST=1;
   /** Use this value to indicate the nameformat to use is 'lastname, firstname middlename'. */
   ...
   /** Returns the full name of a person using only the first- and last name. The default
     * nameformat will be used (NAMEFORMAT_FIRSTMIDDLELAST).
     * @param firstName The first name of the person to retrieve the full name for
     * @param lastName The last name of the person to retrieve the full name for
   ...
   /** Returns the full name of a person using only the first- and last name. It'll use the
     * nameformat specified.
     * @param firstName The first name of the person to retrieve the full name for
     * @param lastName The last name of the person to retrieve the full name for
     * @param nameFormat The name format to use for the full name
     * @return A String containing the full name in the specified name format.
     * @see #NAMEFORMAT_FIRSTMIDDLELAST
   ...
   /** Returns the full name of a person using the first-, middle- and last name. The default
     * nameformat will be used (NAMEFORMAT_FIRSTMIDDLELAST).
     * @param firstName The first name of the person to retrieve the full name for
     * @param middleName The middle name of the person to retreive the full name for
     * @param lastName The last name of the person to retrieve the full name for
     * @return A String containing the full name in the specified name format.
     * @see #NAMEFORMAT_FIRSTMIDDLELAST
     */
   ...
   /** Returns the full name of a person using the first-, middle- and last name. It'll use the
     * nameformat specified.
     * @param firstName The first name of the person to retrieve the full name for
     * @param middleName The middle name of the person to retreive the full name for
     * @param lastName The last name of the person to retrieve the full name for
   ...
   public static String getFullName(String firstName, String middleName, String lastName, int nameFormat) {
      ...
      // If needed trim the name-parts and check to see if the Strings are empty.
      if(firstName!=null) {
