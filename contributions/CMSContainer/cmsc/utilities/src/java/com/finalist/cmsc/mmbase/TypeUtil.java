...
public class TypeUtil {
    ...
    static {
        mmbaseTypes.add("typedef"); mmbaseTypes.add("reldef");
        mmbaseTypes.add("typerel"); mmbaseTypes.add("mmservers");
        mmbaseTypes.add("oalias"); mmbaseTypes.add("daymarks");
        mmbaseTypes.add("syncnodes"); mmbaseTypes.add("icaches");
