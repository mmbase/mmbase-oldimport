...
public class TreeUtil {
   ...
   public static Relation getParentRelation(Node node, String[] treeManagers, String relationName) {
      for (String manager : treeManagers) {
         if (node.getCloud().hasRelationManager(manager, node.getNodeManager().getName(), relationName)) {
            ...
            RelationList parentList = node
                  .getRelations(relationName, node.getCloud().getNodeManager(manager), "SOURCE");
            if (!parentList.isEmpty()) {
   ...
   public static boolean isParent(Node sourceChannel, Node destChannel, String[] treeManagers, String relationName) {
      ...
      // check that the source channel is not a parent of the destination
      // channel
    ...
    * @return List with the path to the root. First item is the root and last is
    *         the node
    */
    ...
    * @param relationName -
    *           relation between the managers
    * @param fragmentFieldnames -
    *           fieldnames the path is constructed with
    * @param includeRoot -
    *           include root to the string
    * @return String with the path to the root.
    */
   public static String getPathToRootString(Node node, String[] treeManagers, String relationName,
         String[] fragmentFieldnames, boolean includeRoot) {
   ...
   public static String getPathToRootStringWithoutCache(Node node, String[] treeManagers, String relationName,
         String[] fragmentFieldnames) {
      String pathStr = "";
   ...
   public static String[] getPathElementsToRoot(Node node, String[] treeManagers, String relationName,
         String[] fragmentFieldnames, boolean includeRoot) {
    ...
    *           fieldname the titles is constructed with
    ...
    * @return titles of nodes in path
    */
   public static String getTitlesString(Node node, String[] treeManagers, String relationName, String titleFieldname,
         boolean includeRoot) {
      String result = "";
      List<Node> path = getPathToRoot(node, treeManagers, relationName);
         ...
         if (level != fragments.length - 1) {
            ...
            while (nli.hasNext()) {
               ...
               if (fragments[level + 1].equalsIgnoreCase(field)) {
                  return getChannelFromPath(cloud, fragments, element, treeManagers, relationName, fragmentFieldnames,
                        level + 1);
               }
            }
         }
   ...
   public static boolean hasChild(Node parent, String fragment, String[] treeManagers, String relationName,
         String[] fragmentFieldnames) {
   ...
   public static Node getChild(Node parentChannel, String fragment, String[] treeManagers, String relationName,
         String[] fragmentFieldnames) {
