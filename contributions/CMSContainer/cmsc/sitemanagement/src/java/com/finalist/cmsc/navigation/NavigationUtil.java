...
public class NavigationUtil {
   ...
   public static String[] treeManagers;// = new String[] { RssFeedUtil.RSSFEED,
                                       // PagesUtil.PAGE, SiteUtil.SITE };
   public static String[] fragmentFieldnames;// = new String[] {
                                             // RssFeedUtil.FRAGMENT_FIELD,
                                             // PagesUtil.FRAGMENT_FIELD,
                                             // SiteUtil.FRAGMENT_FIELD};
   ...
   public static RolesInfo getRolesInfo(Cloud cloud, Node group) {
      ...
      TreeMap<String, UserRole> pagesWithRole = SecurityUtil
            .getRoleMap(treeManagers, NAVREL, fragmentFieldnames, group);
      for (String path : pagesWithRole.keySet()) {
         Node page = getPageFromPath(cloud, path);
         info.expand(page.getNumber());
      }
