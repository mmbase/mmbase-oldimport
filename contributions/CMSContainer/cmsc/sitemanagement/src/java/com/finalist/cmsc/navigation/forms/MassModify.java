    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (isModifyAction(request)) {
            ...
            if (objectnumber > -1 && newLayoutNr > -1) {
                ...
                replaceLayout(page, mform.getRequiredLayout(), newLayout, 
                        mform.isLinkPortlets());
        ...
        for (Node layout : layouts) {
             LabelValueBean bean = new LabelValueBean(layout.getStringValue(PagesUtil.TITLE_FIELD), String.valueOf(layout.getNumber()));
             layoutList.add(bean);
        }
