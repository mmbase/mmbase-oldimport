...
public class PortletTag extends SimpleTagSupport {
    ...
    protected PortletInfo getPortletInfo(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (supported != null && portalContextProvider != null) {
            ...
            while (modes.hasNext()) {
                ...
                if (portalSupport) {
                    ...
                    if (mode.equals(CmscPortletMode.DELETE)) {
                        // Turn the delete mode in an action url instead of a render url
                    ...
                    if (CmscPortletMode.isAdminMode(mode)) {
                        ...
                        if (mayEditPage && CmscPortletMode.isViewMode(currentMode)) {
                            if (mayEditPortlet || mode.equals(CmscPortletMode.DELETE)) {
                                isVisible = true;
                            }
                        }
                    }
                    ...
                    portletInfo.addPortletMode(mode, modeURL.toString(control, new Boolean(request.isSecure())),
                            mode.equals(currentMode), isVisible, modeType);
                }
            }
            ...
            while (states.hasNext()) {
                ...
                portletInfo.addPortletWindowState(state.toString().substring(0, 3), stateURL
                        .toString(control, new Boolean(request.isSecure())), state
                        .equals(currentState));
            }
        }
        return portletInfo;
    ...
    public static class PortletInfo {
        ...
        public void addPortletMode(PortletMode mode, String activationURL, boolean isCurrent, boolean isVisible, String type) {
        ...
        public void addPortletWindowState(String stateLabel, String activationURL, boolean isCurrent) {
            PortletWindowStateInfo pwsi = new PortletWindowStateInfo(stateLabel, activationURL,
                    isCurrent);
