...
public class EditorMessageTag extends
    ...
    public int doEndTag() throws JspException {
		...
		LocalizationContext ctx = (LocalizationContext) renderRequest.getAttribute(Config.FMT_LOCALIZATION_CONTEXT + ".request.editors");
		if(ctx == null) {
