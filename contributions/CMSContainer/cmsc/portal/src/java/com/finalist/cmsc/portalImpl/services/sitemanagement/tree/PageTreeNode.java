...
public class PageTreeNode {
    ...
    /**
     * Get the depth of the element in relation to the root element.
     * The root element has a depth of 0.
     *
     ...
     * to this node's children at index <code>childIndex</code>.
    ...
    /**
     * Returns true if <code>aNode</code> is a child of this node. If <code>aNode</code> is
     * null, this method returns false.
     * @param   aNode node to test as a child of this node
     * @return true if <code>aNode</code> is a child of this node; false if <code>aNode</code>
     *         is null
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (pathfragement == null) {
            if (other.pathfragement != null) return false;
        }
        else
            if (!pathfragement.equals(other.pathfragement)) return false;
        return true;
    }
     ...
     *
     * @param aChild  the child which should be moved
