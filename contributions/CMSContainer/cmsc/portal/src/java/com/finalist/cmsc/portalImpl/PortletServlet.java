...
public class PortletServlet extends HttpServlet {
	...
	private void dispatch(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PortletDefinition portletDefinition = (PortletDefinition) request.getAttribute(PortalConstants.CMSC_PORTLET_DEFINITION);
		try {
			...
			if (method_id == Constants.METHOD_RENDER) {
				...
				portletConfig = PortletObjectAccess.getPortletConfig(this.getServletConfig(), portletContext, portletDefinition);
			 ...
			 * javax.servlet.UnavailableException(e.getMessage()); } else {
