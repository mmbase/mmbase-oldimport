...
<table cellpadding="0" cellspacing="0" class="list" style="margin-top : 50px;" width="75%">
  <tr>
    <th colspan="3" align="center" >
      <mm:write referid="mlg_Delete" /> <mm:write referid="mlg_member"/> 
    </th>
  </tr>
  ...
  <tr>
    <td colspan="2" align="center">
      <mm:write referid="mlg_Delete" /> <mm:write referid="mlg_member"/> : <mm:node number="$removeposterid"><mm:field name="account" /> (<mm:field name="firstname" /> <mm:field name="lastname" />)</mm:node>
    </td>
  </tr>
  ...
  <tr>
    <td align="center" ><input type="submit" value="<mm:write referid="mlg_Delete" />"> </td>
    <td>
      </form> 
      <form action="<mm:url page="index.jsp">
	<mm:param name="forumid" value="$forumid" />
