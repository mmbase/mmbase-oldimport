...
<mm:import externid="inforum">all</mm:import>
	...
	<table align="center" cellpadding="0" cellspacing="0" class="list" style="margin-top : 40px;" width="55%">
		...
		<tr><td colspan="2" height="40" align="center"><b>THIS PAGE GENERATES FAKE REPLYS BE CAREFUL</b></td></tr>
		<form action="replys.jsp" method="post">
		<tr>
		...
		<tr>	
			<form action="replys.jsp" method="post">
				<td>Number of replys to be created</td>
		...
		<tr>
			...
			<input type="hidden" name="action" value="generatereplys">
