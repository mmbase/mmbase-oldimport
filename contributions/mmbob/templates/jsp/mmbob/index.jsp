...
<mm:compare referid="forumid" value="unknown">
  <table align="center" cellpadding="0" cellspacing="0" class="list" style="margin-top : 40px;" width="75%">
    ...
    <tr><td height="40">
      <b>ERROR : </b> 
      No forum id is provided, if this is a new install try <a href="forums.jsp">forums.jsp</a> instead to create a new forum.
    </td></tr>
  </table>
</mm:compare>
      ...
      <mm:compare referid="posterid" value="-1" inverse="true">
        ...
        <td align="left" valign="top">
          ...
          <p>
            <br />
            <b>
              There are 0 new and 0 unread <a href="<mm:url page="privatemessages.jsp" referids="forumid" />">private messages</a>
            </b>
