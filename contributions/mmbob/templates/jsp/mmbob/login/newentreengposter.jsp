...
<table cellpadding="0" cellspacing="0" class="list" style="margin-top : 50px;" width="50%">
 	<form action="<mm:url page="newentreengposter.jsp" referids="forumid,rulesaccepted">
 	...
 	<form action="<mm:url page="newentreengposter.jsp" referids="forumid,rulesaccepted">
        ...
        <mm:compare referid="entree" value="null">
			<tr><th width="150" ><mm:write referid="mlg.Account"/></th><td>
				...
				<input name="newaccount" value="<mm:write referid="newaccount"/>" type="hidden" />
			</td></tr>
			<mm:compare referid="hasnick" value="true">
			<tr><th width="150" >Nick</th><td>
			...
			<input name="newpassword" type="hidden" value="<mm:write referid="newpassword" />" />
			<mm:import externid="newconfirmpassword" />
			<input name="newconfirmpassword" type="hidden" value="<mm:write referid="newconfirmpassword" />"  />
			<tr><th><mm:write referid="mlg.Firstname"/></th><td>
				<mm:import externid="newfirstname" />
				<mm:write referid="newfirstname" />
				<input name="newfirstname" value="<mm:write referid="newfirstname" />" type="hidden"  />
				</td></tr>
			<tr><th><mm:write referid="mlg.Lastname"/></th><td>
				<mm:import externid="newlastname" />
				<mm:write referid="newlastname" />
				<input name="newlastname" value="<mm:write referid="newlastname" />" type="hidden" />
				</td></tr>
			<tr><th><mm:write referid="mlg.Email"/></th><td>
				<mm:import externid="newemail" />
				<mm:write referid="newemail" />
				<input name="newemail" value="<mm:write referid="newemail" />" type="hidden" />
				</td></tr>
			<tr><th><mm:write referid="mlg.Location"/></th><td>
