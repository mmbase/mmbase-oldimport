...
<mm:compare value="docbookprincipleset" referid="action">
	<mm:import externid="exportsetid" />
	<mm:import externid="filepath" />
	<mm:import id="feedback" reset="true"><mm:function set="principletracker" name="docbookPrincipleSet" referids="exportsetid,filepath" /></mm:import>           
	<b>*** <mm:write referid="feedback" /> ***</b>
</mm:compare>
