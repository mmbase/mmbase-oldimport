...
public final class Attributes {
     ...
     * Note that you can specify this attribute separately, but the "case-sensitive" attribute
     ...
     * if <code>true</code>, the storage layer always fails when encountering fieldnames that are reserved sql keywords,
     ...
     * By default, this option is <code>false</code>.
     * Note that you can specify this attribute separately, but the "enforce" attribute
     * of the "disallowedfields" tag overrides this attribute.
     */
     ...
     * A default prefix to place in front of disallowed fieldnames to make them suitable for use in a storage layer.
     * By default, this option is not set.
     */
