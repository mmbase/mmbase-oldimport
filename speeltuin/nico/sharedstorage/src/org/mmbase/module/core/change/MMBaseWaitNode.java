...
/**
 * MMBaseWaitNode is a wrapper class for MMObjectNode we want to
 ...
 *
 */
public class MMBaseWaitNode {

    /** MMbase logging system */
    private static Logger log = Logging.getLoggerInstance(MMBaseWaitNode.class.getName());
     ...
     * @javadoc
     */
    public MMBaseWaitNode(MMObjectNode node) {
        this.node=node;
