...
public class DataApps1Package extends BasicPackage implements PackageInterface {
    ...
    public static final String DTD_OBJECTSET_1_0 = "objectset_1_0.dtd";
    public static final String DTD_RELATIONSET_1_0 = "relationset_1_0.dtd";

    public static final String PUBLIC_ID_DATASET_1_0 = "-//MMBase//DTD dataset config 1.0//EN";
    public static final String PUBLIC_ID_OBJECTSET_1_0 = "-//MMBase//DTD objectset config 1.0//EN";
    public static final String PUBLIC_ID_RELATIONSET_1_0 = "-//MMBase//DTD relationset config 1.0//EN";
    ...
    private MMObjectNode createNewObject(XMLBasicReader nodereader,MMObjectBuilder bul,Element n,JarFile jf) {
	   ...
	   if (owner==null)  owner="import";
	   MMObjectNode newnode = bul.getNewNode(owner);
	   if (alias!=null) newnode.setAlias(alias);
		...
		String value=null;
		if (n3!=null) value=n3.getNodeValue();
