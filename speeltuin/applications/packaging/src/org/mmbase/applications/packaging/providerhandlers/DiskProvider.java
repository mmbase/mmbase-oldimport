...
public class DiskProvider extends BasicProvider implements ProviderInterface,Runnable {
    private static Logger log = Logging.getLoggerInstance(DiskProvider.class.getName());
    private Thread kicker;
  

    /** DTD resource filename of the package DTD version 1.0 */
    public static final String DTD_PACKAGE_1_0 = "package_1_0.dtd";
    public static final String DTD_BUNDLE_1_0 = "bundle_1_0.dtd";
    ...
    public static final String PUBLIC_ID_BUNDLE_1_0 = "-//MMBase//DTD bundle config 1.0//EN";
    ...
    public void init(org.w3c.dom.Node n,String name,String method,String maintainer) {
       ...
       while (n2!=null) {
         if (n2.getNodeName().equals("path")) {
              ...
              if (n3!=null) path=n3.getNodeValue();
         }
			...
			org.w3c.dom.Node n3=n2.getFirstChild();
				...
				name=n3.getNodeName();
					...
					// decode the included
                        		...
                        		if (n5!=null) {
						if (n5.getNodeValue().equals("true")) included=true;
					}
