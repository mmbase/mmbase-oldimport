...
public class ProviderManager {
	...
	if (reader==null) reader = getAutoConfigReader(url+"/mmpm/shareautoconfig.jsp");
	if (reader==null) reader = getAutoConfigReader(url+"/mmbase-webapp/mmpm/shareautoconfig.jsp");
