...
public class CloudModelPackage extends BasicPackage implements PackageInterface {
    ...
    public static final String DTD_CLOUDMODEL_1_0 = "cloudmodel_1_0.dtd";

    /** Public ID of the cloudmodel DTD version 1.0 */
    public static final String PUBLIC_ID_CLOUDMODEL_1_0 = "-//MMBase//DTD cloudmodel config 1.0//EN";
	...
	MMBase mmb=MMBase.getMMBase();
        for(Enumeration ns=reader.getChildElements("cloudmodel.neededreldeflist","reldef");
            ...
            if ("unidirectional".equals(direction)) {
                if (!installRelDef(source,target,1,guisourcename,guitargetname,builder,step)) return false;
            } else {
                if (!installRelDef(source,target,2,guisourcename,guitargetname,builder,step)) return false;
            }
