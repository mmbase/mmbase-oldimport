...
<related:wizard  title="Video Fragmenten" nodetype="videofragments" >

    <edit:path name="Video Fragmenten" session="videofragments"/>
    <edit:sessionpath/>
...
--%>
    ...
    <list:search nodetype="videofragments" collapsed="${empty param.search}">
