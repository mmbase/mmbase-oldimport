...
public class ConstraintParserTest  {
    ...
    public void setUp() throws Exception {
        ...
        instance = new ConstraintParser(ConstraintParser.BRIDGE, query);
    }
    ...
    public void testGetField() {
        Step step1 = query.addStep(images.getName()).setAlias("step1");
        ...
        RelationStep step2 = query.addRelationStep("insrel", news.getName());
    ...
    public void testGetField2() {
        ...
        Step step1 = query.addStep(images.getName()).setAlias("step1");
        StepField field = ConstraintParser.getField(ConstraintParser.BRIDGE, "number", steps);
        assertTrue(field.toString(), field.getStep() == step1);
        assertTrue(field.toString(), field.getFieldName().equals("number"));
        assertTrue(field.toString(), field.getAlias() == null);

        field = ConstraintParser.getField(ConstraintParser.BRIDGE, "step1.number", steps);
        assertTrue(field.toString(), field.getStep() == step1);
        assertTrue(field.toString(), field.getFieldName().equals("number"));
        assertTrue(field.toString(), field.getAlias() == null);
        ...
        try {
            // Field does not exist, should throw IllegalArgumentException.
            ConstraintParser.getField(ConstraintParser.BRIDGE, "step1.abcdef", steps);
            fail("Field does not exist, should throw IllegalArgumentException.");
        } catch (IllegalArgumentException e) {}
    ...
    public void testParseSimpleCondition() {
        query.addStep(images.getName()).setAlias("step1");
        RelationStep step2 = query.addRelationStep("insrel", news.getName());
        step2.getNext();
