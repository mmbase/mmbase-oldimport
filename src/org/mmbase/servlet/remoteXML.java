 ...
 *
 * @version $Revision: 1.26 $ $Date: 2002-04-19 12:30:41 $
  * @rename RemoteXML
 */
        ...
        while (t.hasMoreElements()) {
            ...
            if (!key.equals("number")
                ...
                && !key.equals("owner")) {
                    ...
                    // Storing string values in MMObjectrNode will generally work fine,
                    // as values are converted when they are retrieved.
