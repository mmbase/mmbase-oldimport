...
public class RemoteGenerator{
    ...
    /**
     * This method generates an interface based on
     * an XMLClass
     */
    ...
    public void generateInterface(XMLClass xmlClass){
        ...
        while(methodsEnum.hasMoreElements()){
            ...
            if (!  xmlMethod.getName().equals("equals") && !  xmlMethod.getName().equals("hashCode") && ! xmlMethod.getName().equals("toString")){
                ...
                if (retTypeName == null){
                    retTypeName = xmlMethod.getReturnType().getName();
                }
    ...
    public void generateRmi(XMLClass xmlClass){
        ...
        sb.append("public class "+ className +" extends  UnicastRemoteObject implements Remote"+ shortName +"  {\n");
	...
	if (argv.length !=2 ){
		System.err.println("Usage RemoteGenerator targetdir mmci-xml-file");
		System.exit(1);
	}
