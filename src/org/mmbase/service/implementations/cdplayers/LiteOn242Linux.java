...
public class LiteOn242Linux implements cdplayerInterface {
    ...
    private static Logger log = Logging.getLoggerInstance(LiteOn242Linux.class.getName());
...
/** -------------------------------------------------------- */
    ...
    public void getInfo()
    {
        ...
        log.info("Information about disk : " + discID);
        for (int i =0; i < numberOfTracks; i++)
        {
            log.info("Track ["+i+"] " + convertMinutesSeconds(tracks[i]));
        }
        log.info("Total time : " + convertMinutesSeconds(cdLength));
    }
    ...
    public String getInfoCDtoString() {
        ...
        log.info("getInfoCDtoString "+result);
        return(result);
    }
