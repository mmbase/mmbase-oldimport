 ...
 * @version $Id: Framework.java,v 1.8 2006-10-14 16:51:03 michiel Exp $
 * @since MMBase-1.9
 */
public interface Framework {
     ...
     */
    public StringBuffer getUrl(String page, Component component, Parameters blockParameters, Parameters frameworkParameters, boolean escapeAmps);
     ...
     * @param frameworkParameters The parameters that are required by the framework, for instance containing the 'request' and 'cloud'.
     */
    public StringBuffer getUrl(String page, Renderer renderer, Component component, Parameters blockParameters, Parameters frameworkParameters, boolean escapeAmps);
