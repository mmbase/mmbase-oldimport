 ...
 * @version $Id: BuilderWriter.java,v 1.5 2002-06-18 06:55:47 pierre Exp $
 */
public class BuilderWriter extends DocumentWriter  {
    ...
    public BuilderWriter(MMObjectBuilder builder) throws DOMException {
        super("builder", "-//MMBase/DTD builder config 1.0//EN","http://www.mmbase.org/dtd/builder_1_0.dtd");
