 ...
 * @version $Id: XMLBuilderWriter.java,v 1.23 2002-06-18 09:19:29 pierre Exp $
 */
public class XMLBuilderWriter  {
    ...
    public static boolean writeXMLFile(String filename,MMObjectBuilder bul) {
        String header = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"+
                        "<!DOCTYPE builder PUBLIC \"-//MMBase/DTD builder config 1.0//EN\" \"http://www.mmbase.org/dtd/builder_1_1.dtd\">\n";
        ...
        if (names!=null) {
            ...
            body.append("\t<singular xml:lang=\"en\">"+bul.getSingularName()+"</singular>\n");
        }
