 ...
 */
public class scannersProbe implements Runnable {

	Thread kicker = null;
	scanners parent=null;
	int trackNr=-1;
	String filename=null;
	MMObjectNode node=null;

	public scannersProbe(scanners parent,MMObjectNode node) {
		this.parent=parent;
		this.node=node;
		init();
	}
	...
	public void start() {
		...
		if (kicker == null) {
			kicker = new Thread(this,"scanners");
			kicker.start();
		}
	}
	...
	public void run () {
		...
		if (state.equals("getdir")) {
			System.out.println("SCANNERSPROBE getdir");
