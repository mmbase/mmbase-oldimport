...
<form>
  ...
  <tr><td>
   ...
   You can also upload images with an editwizard. Here is shown how this is can be done.
  </td></tr>
  <tr><td>
	<a href="<mm:url page="/mmapps/editwizard/jsp/list.jsp?wizard=samples/news&nodepath=news&fields=title,owner" />" >News</a>
    </td><td> 
   An editor for news articles. In the one step you can create or add a news article and related people and images to it.
  </td></tr>
  </table>
  <hr />
