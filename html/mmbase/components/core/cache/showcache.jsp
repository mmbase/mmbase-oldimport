...
%><%@page import="org.mmbase.bridge.*,org.mmbase.cache.*,java.util.*,java.util.regex.*,org.mmbase.storage.search.implementation.database.BasicSqlHandler,org.mmbase.storage.search.SearchQuery" %>
<div
...
<% } %>
<tr class="footer">
<td class="navigate"><a href="<mm:url page="cache" />"><img src="<mm:url page="/mmbase/style/images/back.gif" />" alt="back" border="0" /></td>
