...
<mm:listnodes type="mmservers" >
  <tr>
	<td>
	  <mm:field name="name">
		<mm:compare value="<%= MMBase.getMMBase().getMachineName() %>">
		  <a href="<mm:url referids="_@server" page="server/actions.jsp" />"><mm:write /></a>
		</mm:compare>
	...
	<td>
	  <mm:field name="name">
		<mm:compare value="<%= MMBase.getMMBase().getMachineName() %>">
		  <a href="<mm:link referids="_@server" />"><img src="<mm:url page="/mmbase/style/images/next.gif" />" alt="next" /></a>
		</mm:compare>
	  </mm:field>
	</td>
  </tr>
