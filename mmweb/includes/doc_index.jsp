...
<mm:present inverse="true" referid="docnr">
   <mm:list path="pages,articles" fields="articles.number,articles.body" nodes="$page">
    ...
    <mm:list path="pages,documentation" nodes="$page" orderby="documentation.title" directions="down" >
        <li><a href="<mm:url page="/index.jsp?portal=199&page=25011"><mm:param name="docnr"><mm:field name="documentation.number"/></mm:param></mm:url>"><mm:field name="documentation.title"/></a>
    </mm:list>
</mm:present>
...
<mm:present referid="docnr">
    <mm:node referid="docnr">
        <br/>
        <h4><a href="<mm:url page="/index.jsp?portal=199&page=25011" />">Back to overview</a></h4>
        <br/>
