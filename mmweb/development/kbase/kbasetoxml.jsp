...
<mm:cloud jspvar="wolk" method="asis"><
  ...
  ><treeview title="Kbase category structure">
	<custom-parameters>
		...
		<param name="img-directory" value="img/"/>
	</custom-parameters>
...
<%!
    ...
    //alleen doen als huidige node zichtbaar is of editor='true'
      ...
      while(childCategories.hasNext()){
        ...
        if(visible==true || editor==true){
          ...
          //dan xml printen
          out.println(indent(indent)+"<folder title=\""+child.getStringValue("name")+"\" "+
          ...
          showQuestions(wolk, out, child, indent);
  ...
  void showQuestions(Cloud wolk, JspWriter out, Node category,int indent) throws java.io.IOException{
    ...
    while (questions.hasNext()){
      ...
      out.println(indent(indent) + "<leaf title=\""+question.getStringValue("question")+
