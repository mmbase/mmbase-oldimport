...
%><%
     ...
     *
     * @since    MMBase-1.6
     * @version  $Id: popupwizard.jsp,v 1.6 2002-05-23 08:12:13 pierre Exp $
     * @author   Kars Veling
    ...
    if (wizardname!=null && objectnumber!=null && !wizardname.equals("") && !objectnumber.equals("") && wizardname.indexOf("|")==-1) {
        if ("true".equals(inline)) {
            ...
            response.sendRedirect(response.encodeURL("wizard.jsp?fid="+parentFid+"&did="+parentDid+"&wizard="+wizardname+"&sessionkey="+sessionkey+"&objectnumber="+objectnumber+"&referrer="+ewconfig.backPage));
        }
    } else {
