...
%><%
	...
	CloudContext con = LocalContext.getCloudContext();
	HashMap map=new HashMap();
	map.put("username",session.getAttribute("editwizard.username"));
	map.put("password",session.getAttribute("editwizard.password"));
	Cloud cloud = con.getCloud("mmbase","name/password",map);
	...
	Wizard wiz = createNewWizard(settings_basedir, wizard, null, username, password);
