...
%><%
    if (settings_context == null) {
        settings_context = request.getContextPath();
   }
  
    if(settings_basedir == null) {
        String jspFile = getServletConfig().getServletContext().getRealPath(request.getRequestURI().substring(settings_context.length()));
