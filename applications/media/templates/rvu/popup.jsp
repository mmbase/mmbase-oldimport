...
/><mm:cloud><mm:node  number="$fragment"><a href="javascript:window.open('http://<%=getHost() + getTemplatesDir() + "rvu/popuppage.jsp?fragment="%><mm:field name="number" />','<mm:field name="title" />', 'width=350,height=280,scrollbars=no');"><mm:field name="title" /></a> <mm:field name="html(intro)" />
