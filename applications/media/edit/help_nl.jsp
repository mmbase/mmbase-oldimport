...
<body class="help">
  ...
  <p>
    ...
    <ul>
      <li><a href="#editor">Een editor</a></li>
      <li><a href="#search">Een zoek-mogelijkheid</a></li>
    </ul>
  </p>  
  ...
  <p>
    ...
    van het bestand, het type en de encodering. Dit soort informatie is meestal niet essentieel of
    kan ook automatisch bepaald worden en in het algemeen zal u dit niet hoeven invoeren.
  </p>
  <p>
