...
<mm:node number="$origin">
  ...
  <table class="entrance">
    ...
    <tr>
      ...
      <td>
        ...
        <a href="<mm:url referids="referrer,origin,language,context" page="${jsps}wizard.jsp">
    ...
    <tr>
      ...
      <td>
        <form style="display: inline; " id="clippingaudio" action="<mm:url referids="referrer,language,context" page="${jsps}list.jsp" />" method="post">
           <select name="searchfields">
  ...
  <tr>
   <td><%=m.getString("baseaudio")%></td><td><form style="display:inline; " id="baseaudio" action="<mm:url referids="referrer,language,context" page="${jsps}list.jsp" />" method="post">
           <select name="searchfields">
              <mm:write referid="audiofieldoptions" escape="none" />             
           </select>
           <input type="text" name="searchvalue" />
       ...
       <a href="<mm:url referids="referrer,language,context" page="${jsps}wizard.jsp">
