...
public class DisplayHtmlCreator extends BasicCreator implements CreatorInterface {
     ...
     */
    public final static String DTD_PACKAGING_DISPLAY_HTML_1_0 = "packaging_display_html_1_0.dtd";
    /**
     *  Description of the Field
     */
    public final static String PUBLIC_ID_PACKAGING_DISPLAY_HTML_1_0 = "-//MMBase//DTD packaging_display_html config 1.0//EN";
    ...
    /**
     *Constructor for the DisplayHtmlCreator object
     */
    public DisplayHtmlCreator() {
        cl = DisplayHtmlCreator.class;
        prefix = "packaging_display_html";
    }
    ...
    public boolean createPackage(Target target, int newversion) {
        ...
        step.setUserFeedBack("display/html packager started");
        ...
        try {
            ...
            int filecount = addFiles(jarfile, basedir, include, exclude, "display", "html");
            if (filecount == 0) {
                step = getNextPackageStep();
	...
	if (target.getPublishState()) {
        ...
        step = getNextPackageStep();
        step.setUserFeedBack("display/html packager ended : " + getErrorCount() + " errors and " + getWarningCount() + " warnings");
    ...
    /**
     *  Gets the xMLFile attribute of the DisplayHtmlCreator object
     *
     * @param  target  Description of the Parameter
    ...
    /**
     *  Sets the defaults attribute of the DisplayHtmlCreator object
     *
     * @param  target  The new defaults value
     */
    public void setDefaults(Target target) {
        target.setItem("basedir", "templates/jsp/");
