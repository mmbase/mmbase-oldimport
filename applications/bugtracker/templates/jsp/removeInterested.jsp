...
<FORM ACTION="executes/removeInterested.jsp?bugreport=<mm:write referid="bugreport" />" METHOD="POST">
...
<TR>
		...
		<TD BGCOLOR="#00425A" COLSPAN="1">
			<mm:list nodes="$bugreport" path="bugreports,rolerel,users" constraints="rolerel.role='interested'">
