...
<mm:list path="pools,bugreports,areas" nodes="BugTracker.Start" orderby="bugreports.number" directions="down" constraints="<%=where%>">
	<mm:last>
		<mm:import id="total" jspvar="tmp"><mm:index/></mm:import>
	</mm:last>
</mm:list>
<% String total="0"; %>
...
<mm:last>
<mm:import id="last" jspvar="last" ><mm:index offset="$offset" /></mm:import>
</mm:last>
</mm:list>
...
<TR>
	...
	<TD BGCOLOR="42BDAD">
			<mm:compare referid="offset" value="0" inverse="true"><a href="index2.jsp?offset=<%=(offseti-15)%>&where=<%=where%>"><IMG SRC="images/arrow2.gif" BORDER="0" ALIGN="left"></a></mm:compare>
	</TD>
	<TD BGCOLOR="42BDAD">
		<FONT COLOR="#000000">
			<% if (!total.equals("0")) { %>
	...
	<TD BGCOLOR="42BDAD">
			<% if (((lasti+1)!=totali) && !total.equals("0")) { %><a href="index2.jsp?offset=<%=(offseti+15)%>&where=<%=where%>"><IMG SRC="images/arrow.gif" BORDER="0" ALIGN="left"></a><% } %>
	</TD>
	</TABLE>
	</CENTER>
	</TD>
