...
<tr>
    ...
    <mm:compare referid="flap" value="search" inverse="true">
       <td><a href="<mm:url referids="portal?,page?" page="$base/index.jsp?flap=search" />">Search</a></td>
    </mm:compare>
    ...
    <mm:compare referid="flap" value="lastchanges" inverse="true">
       <td><a href="<mm:url referids="portal?,page?" page="index.jsp?flap=lastchanges" />">Last changed</a></td>
    </mm:compare>
    ...
    <mm:compare referid="flap" value="stats" inverse="true">
      <td><a href="<mm:url referids="portal?,page?" page="index.jsp?flap=stats" />">Statistics</a></td>
    </mm:compare>
