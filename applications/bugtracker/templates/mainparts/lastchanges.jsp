...
<tr>
		...
		<td>
			<A HREF="fullview.jsp?bugreport=<mm:field name="number" />&portal=<mm:write referid="portal" />&page=<mm:write referid="page" />"><IMG SRC="/development/bugtracker/images/arrow-right.gif" BORDER="0" ALIGN="middle"></A>
		</td>
</tr>
</mm:listnodes>
</tr>
